...
import { LayoutDashboard, Building2, Users, Sparkles, UserCog, Briefcase, Upload, Database, LogOut, Menu, X } from 'lucide-react'
...
export function Layout() {
  ...
  const links = [
    ...
    ...(isAdmin && !demoMode ? [{ to: '/setup', label: 'Cloud setup', icon: Database }] : []),
